...
Do you know Harl?
We all do, don’t we?
In case you don’t, find below the kind of comments Harl makes.
...
Example: "I think I deserve to have some extra bacon for free.
...
above depending on the level passed as a parameter: 
...
He doesn’t think twice! Create and turn in tests to show that Harl complains a lot.
You can use the examples of comments listed above in the subject
or choose to use comments of your own.
